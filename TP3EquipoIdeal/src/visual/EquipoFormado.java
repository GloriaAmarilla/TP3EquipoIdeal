...
public class EquipoFormado {
    ...
    public EquipoFormado(PersonalLaboral personal, int cantLideres, int cantArquitectos,
    ...
    private void initialize() {
        ...
        tablaEquipo.getTableHeader().setFont(new Font("Arial", Font.BOLD, 15));
        ...
        lblCalificacion.setFont(new Font("Arial", Font.BOLD, 18));
        ...
        lblEvaluaciones.setFont(new Font("Arial", Font.PLAIN, 16));
        ...
        btnNuevaBusqueda.setFont(new Font("Arial", Font.PLAIN, 18));
    ...
    private void iniciarBusqueda() {
                        ...
                        if (equipo.isEmpty()) {
                            ...
                            for (Persona p : equipo) {
                                modeloTabla.addRow(new Object[]{
                                    p.getNombre(), p.getApellido(), p.getRol(), p.getCalificacion()
                                });
                            }
        ...
        EquipoIdeal equipo = new EquipoIdeal(
            _cantLideres, _cantArquitectos, _cantProgramadores, _cantTesters, _personal, listener
        );
