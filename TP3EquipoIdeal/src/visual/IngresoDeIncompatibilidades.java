...
public class IngresoDeIncompatibilidades {
    ...
    public IngresoDeIncompatibilidades(PersonalLaboral personal, int cantLideres,
            int cantArquitectos, int cantProgramadores, int cantTesters) {
        _personal = personal;
    ...
    private void initialize() {
        ...
        lblPersona1.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        lblPersona2.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        btnAgregarIncompat.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        tablaIncompat.getTableHeader().setFont(new Font("Arial", Font.BOLD, 14));
        ...
        JLabel lblSiguiente = new JLabel("Cuando termines de cargar incompatibilidades:");
        lblSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
        lblSiguiente.setForeground(new Color(139, 0, 0));
        lblSiguiente.setFont(new Font("Arial", Font.BOLD, 17));
        lblSiguiente.setBounds(10, 380, 580, 35);
        frmIncompatibilidades.getContentPane().add(lblSiguiente);

        JButton btnFormarEquipo = new JButton("Formar Equipo");
        btnFormarEquipo.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        btnAgregarIncompat.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (idx1 == idx2) {
                    JOptionPane.showMessageDialog(frmIncompatibilidades,
                        "Seleccione dos personas distintas.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
        ...
        btnFormarEquipo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EquipoFormado equipoFormado = new EquipoFormado(
